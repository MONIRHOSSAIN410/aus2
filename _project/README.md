...
- `public/cursor-mark.png` — the custom cursor, in the spirit of the katana cursor on zenji.shop
...
- Product photography is loaded from the live Cloudinary account — see **Imagery** above to self-host it
